(()=>{"use strict";var e,t,i,o,r={5(e,t,i){let o,r,s,n,a,l,d;i(702),i(229);var c,p,u,h,g,f,m,w,b,x,y,v,E,S,_,I,C,k,N=i(988),O=i(376);let T={enabled:!0,minLevel:"debug",maxEntries:500,redactKeys:["password","token","secret","authorization","cookie"]},A={debug:10,info:20,warn:30,error:40,silent:99};c=(0,O.Injectable)({providedIn:"root"});class B{static #e={c:[o,p]}=(0,N._)(this,[],[c]);options=T;sequence=0;entries=[];sinks=new Set;configure(e){this.options={...this.options,...e,redactKeys:e.redactKeys??this.options.redactKeys}}shouldLog(e){return!!this.options.enabled&&A[e]>=A[this.options.minLevel]}emit(e){let t={...e,id:++this.sequence,timestamp:new Date().toISOString()};for(let e of(this.entries.push(t),this.entries.length>this.options.maxEntries&&this.entries.shift(),this.sinks))e(t)}sanitize(e){return function e(t,i){let o=arguments.length>2&&void 0!==arguments[2]?arguments[2]:0;if(o>4)return"[Truncated]";if(null==t||"number"==typeof t||"boolean"==typeof t)return t;if("string"==typeof t)return t.length>2e3?`${t.slice(0,2e3)}…`:t;if(t instanceof Error)return{name:t.name,message:t.message,stack:t.stack};if(Array.isArray(t))return t.map(t=>e(t,i,o+1));if("object"==typeof t){let r={};for(let[s,n]of Object.entries(t))r[s]=i.has(s.toLowerCase())?"[REDACTED]":e(n,i,o+1);return r}return String(t)}(e,new Set(this.options.redactKeys.map(e=>e.toLowerCase())))}snapshot(){return[...this.entries]}clear(){this.entries=[]}addSink(e){this.sinks.add(e)}removeSink(e){this.sinks.delete(e)}consoleSink(e){let t="debug"===e.level?"debug":"info"===e.level?"info":e.level,i=`[${e.timestamp}] [${e.level.toUpperCase()}] [${e.namespace}]`;e.error?console[t](`${i} ${e.message}`,e.context,e.error):console[t](`${i} ${e.message}`,e.context)}backendSink(e){try{if("u">typeof window){let t=window;if("function"==typeof t.log_message){let i={message:e.message,level:e.level.toUpperCase(),meta:e.context,category:e.namespace,session_id:"frontend",frontend_timestamp:e.timestamp};t.log_message(JSON.stringify(i))}}}catch{}}enableConsoleSink(){this.addSink(this.consoleSink.bind(this))}enableBackendSink(){this.addSink(this.backendSink.bind(this))}static #t=p()}class D{backend;namespace;baseContext;constructor(e,t,i={}){this.backend=e,this.namespace=t,this.baseContext=i}child(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};return new D(this.backend,`${this.namespace}.${e}`,{...this.baseContext,...t})}withContext(e){return new D(this.backend,this.namespace,{...this.baseContext,...e})}debug(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};this.log("debug",e,t)}info(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};this.log("info",e,t)}warn(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},i=arguments.length>2?arguments[2]:void 0;this.log("warn",e,t,i)}error(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},i=arguments.length>2?arguments[2]:void 0;this.log("error",e,t,i)}log(e,t){let i=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{},o=arguments.length>3?arguments[3]:void 0;if(!this.backend.shouldLog(e))return;let r=function(e){if(null!=e)return e instanceof Error?{name:e.name,message:e.message,stack:e.stack}:{name:"UnknownError",message:"string"==typeof e?e:JSON.stringify(e)}}(o),s=this.backend.sanitize({...this.baseContext,...i});this.backend.emit({level:e,namespace:this.namespace,message:t,context:s,error:r})}}let R=new o,z=(R.enableConsoleSink(),new D(R,"frontend"));function W(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};return e?z.child(e,t):z.withContext(t)}let L=W("winbox");"u">typeof window&&window.WinBox?L.debug("WinBox loaded and available on window.WinBox"):L.warn("WinBox was imported but not found on window object");var F=i(723),U=i(114);u=(0,O.Component)({selector:"app-error-modal",standalone:!0,imports:[U.MD],template:`
    @if (error) {
